 ...
 * @group UAVbook
 */
PARAM_DEFINE_FLOAT(UAVBOOK_COURSE_KI, 0.0484f);
 ...
 * @group UAVbook
 */
PARAM_DEFINE_FLOAT(UAVBOOK_ROLL_KP, 0.1f);//1.0712f);
 ...
 * @group UAVbook
 */
PARAM_DEFINE_FLOAT(UAVBOOK_ROLL_KD, 0.01);//0.1086f);
 ...
 * @group UAVbook
 */
PARAM_DEFINE_FLOAT(UAVBOOK_ROLL_KI, 0.0f);//0.10f);
